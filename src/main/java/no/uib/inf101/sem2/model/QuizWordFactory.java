...
public class QuizWordFactory {
    ...
    QuizWord[] level5 = {
        ...
        new QuizWord("Ottesam", "Urolig", Color.BLUE),
        new QuizWord("Vørde", "Ærede", Color.BLUE),
        new QuizWord("Sokneråd", "Menighetsråd", Color.BLUE),
        new QuizWord("Kyrkjelyd", "Menighet", Color.BLUE),
        new QuizWord("Den Høgvørde Kronprinsessa", "Hennes Kongelige Høyhet Kronprinsessen", Color.BLUE),
        new QuizWord("Røynsle", "Erfaring", Color.BLUE),
        new QuizWord("Hugnadsam", "Hyggelig", Color.BLUE),
    ...
    QuizWord[] level4 = {
        ...
        new QuizWord("Røyndomsfjern", "Virkelighetsfjern", Color.MAGENTA),
        new QuizWord("Velgjerd", "Veldedighet", Color.MAGENTA),
        new QuizWord("Utferding", "Utstedelse", Color.MAGENTA),
        new QuizWord("Beinveges", "Umiddelbart", Color.MAGENTA),
        new QuizWord("Dragnad", "Tilbøyelighet", Color.MAGENTA),
        new QuizWord("Venleik", "Skjønnhet", Color.MAGENTA),
        new QuizWord("Mellombels", "Midlertidig", Color.MAGENTA),
        new QuizWord("Førebels", "Foreløpig", Color.MAGENTA),
        new QuizWord("Medynk", "Medlidenhet", Color.MAGENTA),
        new QuizWord("Keisemd", "Kjedsomhet", Color.MAGENTA),
        new QuizWord("Avretting", "Henrettelse", Color.MAGENTA),
        new QuizWord("Attval", "Gjengvalg", Color.MAGENTA),
        new QuizWord("Tverrbuar", "Gjenboer", Color.MAGENTA),
        new QuizWord("Føremon", "Fordel", Color.MAGENTA),
        new QuizWord("Rørsle", "Bevegelse", Color.MAGENTA),
        new QuizWord("Monaleg", "Betydelig", Color.MAGENTA),
        new QuizWord("Stogg", "Stopp", Color.MAGENTA),
        new QuizWord("Vitlaus", "Forrykt", Color.MAGENTA),
        new QuizWord("Fråhald", "Avhold", Color.MAGENTA),
        new QuizWord("I røynda", "I virkeligheten", Color.MAGENTA),
        new QuizWord("Lét", "Lot", Color.MAGENTA),
        new QuizWord("Lèt", "Lar", Color.MAGENTA),
